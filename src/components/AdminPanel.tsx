  ...
  return (
    <div className="admin-panel">
      <div className="admin-grid">
        <div className="card">
          ...
          <form onSubmit={handleAddClient} className="client-form">
            ...
            <div className="form-row">
              <label>Services AWS ({selected.size} sélectionné{selected.size > 1 ? 's' : ''})</label>
                ...
                {catalog.map((item) => (
                  <label key={item.service} className="service-check-item">
                    ...
                    <span className="service-check-price">
                      {formatEUR(item.grossEUR)} <span className="arrow">→</span> {formatEUR(item.totalEUR)}
                    </span>
                  </label>
                ))}
              </div>
      ...
      <div className="card">
        ...
        <div className="sub">Services assignés et facturation associée sur la période sélectionnée</div>
        {clients.length === 0 ? (
