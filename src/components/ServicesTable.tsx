      ...
      <table>
        <thead>
          <tr>
            ...
            <th className='num'>{isClient ? 'Coût HT' : 'Refacturé HT'}</th>
          </tr>
        </thead>
        <tbody>
          {data.map((d) => (
            <tr key={d.service}>
              <td>
                <span className='pill pill-aws'>{d.service}</span>
              </td>
          ...
          <tr className='total-row'>
            ...
            {!isClient && (
              <>
                <td className='num'>
                  <b>{formatEUR(totalGross)}</b>
                </td>
                <td className='num'>
                  <b>{formatEUR(totalMargin)}</b>
                </td>
              </>
            )}
            <td className='num'>
              <b>{formatEUR(totalRefacture)}</b>
            </td>
          </tr>
        </tbody>
      </table>
