...
export default function App() {
  ...
  // Calculs agrégés
  const kpis = useMemo(() => {
    const grossUSD = results.reduce((sum, r) => sum + parseFloat(r.Total.UnblendedCost.Amount), 0)
  ...
  return (
    <div className='app'>
      <Sidebar
        ...
        user={view === 'client' ? 'Sophie Dubois' : 'Thomas Martin'}
        role={view === 'client' ? 'Responsable des opérations numériques' : 'Devops'}
      />
      <main className='main'>
          ...
          <>
            <div className='kpis'>
              <KpiCard
                ...
                value={kpis.forecastEUR}
                trend='down'
                trendLabel='Projection linéaire'
              />
              {view === 'admin' && (
                <>
                  <KpiCard
                  ...
                  />
                  <KpiCard
                    label={`Marge 42c (${MARGIN_PERCENT} %)`}
                    value={kpis.marginEUR}
                    trend='neutral'
                    trendLabel='Standard'
                  />
                  <KpiCard
                    label='Total refacturé HT'
                    value={kpis.totalRefactureEUR}
                    trend='up'
                    trendLabel='▲ 8,4 %'
                    primary
                  />
            ...
            <div className='charts-row'>
              <div className='card'>
                ...
                <div className='sub'>
                  Évolution sur la période sélectionnée, avec marge appliquée
                </div>
              ...
              <div className='card'>
                ...
                <ServiceBreakdownChart data={byService} isClient={view === 'client'} />
              </div>
            </div>
            ...
            <div className='card'>
              ...
              <ServicesTable
                data={byService}
                totalGross={kpis.grossEUR}
                totalMargin={kpis.marginEUR}
                totalRefacture={kpis.totalRefactureEUR}
